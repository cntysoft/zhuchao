...
Ext.define('App.ZhuChao.CategoryMgr.Widget.Entry', {
   ...
   requires : [
      ...
      'App.ZhuChao.CategoryMgr.Ui.Attrs.StdAttrPanel',
   ...
   panelClsMap : {
      ...
      StdAttrPanel : 'App.ZhuChao.CategoryMgr.Ui.Attrs.StdAttrPanel',
   ...
   getContextMenu : function (record)
   {
      ...
      if(record.isRoot()){
         ...
         if(C.NODE_TYPE_NORMAL_CATEGORY == nodeType){
            this.normalNodeContextMenuRef = new Ext.menu.Menu({
               ignoreParentClicks : true,
               items : [{
                     text : L.NORMAL,
                     listeners : {
            ...
            return this.normalNodeContextMenuRef;
...
//                  }, {
//                     text : L.MODIFY_STD_ATTR,
//                     listeners : {
//                        click : function ()
//                        {
//                           this.renderPanel('StdAttrPanel', {
//                              appRef : this.appRef,
//                              mode : 2,
//                              targetLoadId : record.get('id')
//                           });
...
//                     }
   ...
   {
      return {
         xtype : 'shopcategorymgrcompcategorytree',
         region : 'west',
         width : 300,
         margin : '0 1 0 0',
         collapsible : true,
   ...
   panelExistHandler : function (panel, config)
   {
      ...
      } else if(panel.panelType == 'StdAttrPanel'){
         panel.loadNodeStdAttrs(config.targetLoadId);
      }
   },
   destroy : function ()
   {
