...
use App\ZhuChao\Product\Constant as PRODUCTMAIN_CONST;
...
class Utils extends AbstractScript
{
    ...
    * @param array $params
    */
   public function addProductHits($params)
   {
      $this->checkRequireFields($params, array('number'));
      $this->appCaller->call(PRODUCTMAIN_CONST::MODULE_NAME, PRODUCTMAIN_CONST::APP_NAME, PRODUCTMAIN_CONST::APP_API_PRODUCT_MGR, 'addProductHits', array($params['number']));
   }
   ...
   {
      $this->checkRequireFields($params, array('total', 'page', 'limit'));
      $offset = ((int) $params['page'] - 1) * (int) $params['limit'];
      $lists = $this->appCaller->call(
              CONTENT_CONST::MODULE_NAME, CONTENT_CONST::APP_NAME, CONTENT_CONST::APP_API_INFO_LIST, 'getCaseList', array($params['total'], $offset, $params['limit']));
      $ret = array();
