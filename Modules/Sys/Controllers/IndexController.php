...
class IndexController extends AbstractController
{
   ...
   public function indexAction()
   {
      return $this->setupRenderOpt(array(
         ...
         View::KEY_RESOLVE_DATA => CNTY_ROOT_DIR.DS.'PlatformJs/build/production/ZhuChao/index.html'
      ));
   }
   ...
   public function develAction()
   {
      return $this->setupRenderOpt(array(
         ...
         View::KEY_RESOLVE_TYPE   => View::TPL_RESOLVE_DIRECT,
         View::KEY_RESOLVE_DATA => CNTY_ROOT_DIR.DS.'PlatformJs'.DS.'ZhuChao'.DS.'index.html'
      ));
   }
}