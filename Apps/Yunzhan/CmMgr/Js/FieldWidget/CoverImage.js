 ...
 */
Ext.define('App.Yunzhan.CmMgr.Lib.FieldWidget.CoverImage', {
   extend: 'App.Yunzhan.CmMgr.Lib.FieldWidget.AbstractField',
   requires: [
      'App.Yunzhan.CmMgr.Comp.InternetPicWin',
      'App.Yunzhan.CmMgr.Lib.FieldWidget.SelectLocalFileWin',
    ...
    *
    * @private
    * @propery {App.Yunzhan.CmMgr.Comp.InternetPicWin} internetWinRef
    */
   internetWinRef: null,
   /**
    * 文件引用id
   ...
   initComponent: function()
   {
      ...
      var basePath = ZC.getAppUploadFilesPath('Yunzhan', 'Content');
      Ext.apply(this, {
         items: [{
               xtype: 'image',
               height: 160,
   ...
   addInternetImageHandler: function()
   {
      if (null == this.internetWinRef) {
         this.internetWinRef = new App.Yunzhan.CmMgr.Comp.InternetPicWin({
            mutil: false
         });
