 ...
 * 公告编辑器
 */
Ext.define('App.Yunzhan.CmMgr.Lib.Editor.AnnounceEditor', {
   extend: 'App.Yunzhan.CmMgr.Lib.Editor.StdEditor',
   requires: [
      'App.Yunzhan.Content.Comp.RemoteImageSaver'
   ],
   /**
    * @property {App.Yunzhan.Content.Comp.RemoteImageSaver}
    */
   ...
   constructor: function(config)
   {
      ...
      this.remoteImageSaver = new App.Yunzhan.Content.Comp.RemoteImageSaver({
         editor: this
      });
   ...
   saveHandler: function()
   {
      if (this.isBasicFieldsValid()) {
         ...
         this.doSaveAnnounce(values, this.mode);
      }
   },
   /**
    * 保存文章相关信息
    */
   doSaveAnnounce: function(values, mode)
   {
