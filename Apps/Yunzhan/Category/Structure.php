...
use App\Yunzhan\Category\Model\Node as NodeModel;
use App\Yunzhan\Category\Model\C2Map;
use Cntysoft\Kernel;
...
{
   const C2MAP_M_CLS = 'App\Yunzhan\Category\Model\C2Map';
   const NODE_M_CLS = 'App\Yunzhan\Category\Model\Node';
    ...
    *
    * @param int $id
    * @return \App\Yunzhan\Category\Model\Node
    */
