...
final class Constant
{
   ...
   //商品搜索索引
   const GOODS_INDEX_NAME = 'fhzc_b2b_goods';
   const GOODS_INDEX_NAME_DEVEL = 'fhzc_b2b_goods_devel';
   const GOODS_INDEX_NAME_DEBUG = 'fhzc_b2b_goods_debug';
   const GOODS_INDEX_MAIN_TABLE_NAME = 'main';
   //普通文章的搜索索引
   const GENERAL_DOC_INDEX_NAME = 'fhzc_b2b_general_doc';
   const GENERAL_DOC_INDEX_NAME_DEVEL = 'fhzc_b2b_general_doc_devel';
