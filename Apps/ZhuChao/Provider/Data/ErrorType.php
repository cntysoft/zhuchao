...
return array(
   ...
   'E_PROVIDER_PASSWORD_ERROR' => array(10006, 'username or password error'),
   'E_PROVIDER_STATUS_ERROR' => array(10007, 'provider status error'),
   'E_PROVIDER_COOKIE_NOT_EXIST' => array(10008, 'login cookie not exist')
);
