   ...
   $(function (){
      ...
      $(function (){
         $.fn.manhuatoTop = function (options){
            ...
            $('body').prepend('<div id="totop" style="display: block;" > <a id="totop_up"><i class = "icon-jiantou1" > </i></a>\n\
  <a href="' + $('.header_top div.fl a').eq(0).attr('href') + '/feedback.html" class="jianyi"><i class="icon-bianji"></i><em>建议</em></a>\n\
<a href="http://wpa.qq.com/msgrd?v=3&uin=2788984873&site=qq&menu=yes" target="_blank"> <i class = "icon-kefu"> </i><em>客服</em > </a></div >');
            var $toTop = $(this);
            var $top = $('#totop');
