 ...
 */
namespace ZhuChao\Framework\OpenApi\Provider;
use Cntysoft\Kernel;
use Cntysoft\Phalcon\DI\Exception;
use ZhuChao\Kernel\StdErrorType;
use ZhuChao\Framework\OpenApi\ScriptBroker;
...
class FrontApiServer
{
    ...
    protected function initApiWhiteList()
    {
        $this->whiteList = array(
           'Provider.login',
           'Provider.register',
           'Provider.loginByCookie',
           'Provider.checkRegAuthCode', //用户注册发送短信验证码之前的图片验证码
           'Provider.checkForgetAuthCode', //用户找回密码发送短信验证码之前的图片验证码
