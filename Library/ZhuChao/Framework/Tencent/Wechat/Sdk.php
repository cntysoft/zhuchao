 ...
 */
namespace ZhuChao\Framework\Tencent\Wechat;
use Zend\Http\Client as HttpClient;
use Zend\Http\Request as HttpRequest;
use Cntysoft\Kernel;
use ZhuChao\Framework\Tencent\ErrorType;
use ZhuChao\Framework\Tencent\Exception;
use Cntysoft\Kernel\ConfigProxy;
use ZhuChao\Framework\Tencent\Constant;
class Sdk
{
   /**
 ...
 * 负责定义微信接口地址常量
 *
 * @package ZhuChao\Framework\Tencent\Wechat
 */
